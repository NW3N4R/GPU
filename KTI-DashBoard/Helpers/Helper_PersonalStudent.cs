...
namespace KTI_DashBoard.Helpers
{
    ...
    {
        public static List<PersonalStudent> _Student = new List<PersonalStudent>();
        public static List<PersonalStudent> ar_Student = new List<PersonalStudent>();
        ...
        public static async Task<List<PersonalStudent>> ar_GetStudents()
        {
