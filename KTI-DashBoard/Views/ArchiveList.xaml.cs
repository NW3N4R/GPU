...
{
    public sealed partial class ArchiveList : Page
    {
        bool doSearch = false;
        ...
        private void PrintDocument_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (button != null)
            {
                ...
                string url = $"http://p4165386.eero.online/kti/Print/DoArchiveLoadPrint/{id}";
        ...
        private async void DeleteButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                int id = Int32.Parse(button.Tag.ToString());
                await Helper_PersonalStudent.ArchiveDeleteStudent(id);
                Load();
            }
        }
        ...
        private async void DeleteMultiBttn_Click(object sender, RoutedEventArgs e)
        {
            foreach (var item in studentListView.SelectedItems)
            {
                ...
                await Helper_PersonalStudent.ArchiveDeleteStudent(model.id);
            }
            Load();
        }
        ...
        private async void ToExcelExportBttn_Click(object sender, RoutedEventArgs e)
        {
            ...
            ExcelPackage excelPackage = await ToExcelPrint.DoPrint(list,1);
